...
1. In the Copilot, choose **Agent mode**.
...
> [!NOTE]
> The execution generated by Copilot may differ from the example shown above. Above image is just for reference

8. As Copilot creates new files and content, click **Keep** to accept the changes.
    ![agent mode](./images/file-changes.png)


9. After completing all the Todos, Copilot confirm successfull creation of CAP projet and fiori app.

10. Execute prompt `/sap-fiori preview application`. Application should automatically open in your browser, displaying a travel list report application that matches the list report Figma Design.
...
1. Application preview does not open automatically in the browser:
    ...
    - you can start watch script manually:
