...
6. Cline prepares an **Implementation Plan** using the AI model and MCP servers. Once the implementation plan is ready, review it.


> [!NOTE]
> If Cline asks for permission to **get_figma_data**, click on **Approve**.
...
7. Switch to **Act mode**. Cline executes the implementation plan. 
