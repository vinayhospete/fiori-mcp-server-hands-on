...
6. Copilot uses the Figma MCP server to extract the design and prepares implementation plan.
...
8. Review the files and content created by Copilot, then click **Keep** to accept them.
